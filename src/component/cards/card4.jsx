      ...
      if (isLoggedIn) {
        ...
        if (
          ...
          if (response_getFPayment_data.status) {
            ...
            paymentGateWay(response_getFPayment_data?.data?.txnToken, key, item.course_id);
          }
          } else {
            ...
            <div className="courserate">
              <div className="d-flex align-items-center">
                <span className="rating">
                  <IoStar /> {value.avg_rating ? parseFloat(value.avg_rating).toFixed(1) : "0.00"}
                </span>
            ...
            <div className="w-100 mt-2">
              {value.expiry_date && 
                <p className="m-0 mb-1 gap-1 d-flex align-items-center validity">
                  ...
                  Validity:<span className="valid_date">{`${formatDate(value.expiry_date)}`}</span>
                </p>
              }
